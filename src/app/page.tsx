import { CalendarMinimalistic, Document } from "@solar-icons/react/ssr";
...
export default function Home() {
  return (
    <div id="workspace" className="w-full h-screen flex flex-col relative items-center justify-center p-6 md:lg:xl:0">
      ...
      <div className="absolute z-2 top-0 right-0 w-full md:lg:xl:w-2/6 py-4 px-5 flex items-center justify-end gap-4 uppercase font-medium text-[13px]">
        <Link
      ...
      <div className="flex flex-col items-center justify-center my-6">
        ...
        <div className="flex items-center justify-center gap-4 my-4">
          <Link
            href={`/`}
            className="flex items-center uppercase bg-white custom-inset gap-2 text-black text-xs font-medium justify-center px-4 py-2 rounded-md corner-squircle"
          >
            <CalendarMinimalistic weight="Bold" size={14} />
